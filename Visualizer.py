...
class Visualizer:
    ...
    def show_training_loss_pruning(self, indexes=None):
        ...
        for i in range(a, b):
            ...
            ax.plot(self.list_epochs[:len(list_loss)], list_loss, label="Sp = {:.2f}".format(self.list_global_sparsity[i]))
    ...
    def show_test_loss(self):
        f, ax = plt.subplots(figsize=(10, 10))
        ax.plot(self.list_global_sparsity, self.list_test_loss, label="loss")
